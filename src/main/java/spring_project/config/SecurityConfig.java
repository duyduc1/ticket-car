    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                ...
                .authorizeHttpRequests(requests -> requests
                        ...
                        .requestMatchers("/api/adminuser/**" , "/api/useradmin-all-driver/**" ,"/api/user-ticket/**" , "/api/useradmin-all-coach/**" , "/api/useradmin-all-rickshaw/**" , "/api/useradmin-all-tripcar/**" , "/api/api-tripcar/payment" ).hasAnyAuthority("USER", "ADMIN")
